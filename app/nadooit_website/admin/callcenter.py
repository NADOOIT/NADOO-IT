...
from django.contrib import admin
from nadooit_website.models import OnlineVideoMeetingRequest


class OnlineVideoMeetingRequestAdmin(admin.ModelAdmin):
    list_display = (
        "id",
        "session",
        "status",
...
admin.site.register(OnlineVideoMeetingRequest, OnlineVideoMeetingRequestAdmin)
