...
urlpatterns = [
    ...
    path(
        "customer-program-execution-list-compaint-modal/<uuid:customer_program_execution_id>",
        customer_program_execution_list_compaint_modal,
        name="customer-program-execution-list-compaint-modal",
    ),
